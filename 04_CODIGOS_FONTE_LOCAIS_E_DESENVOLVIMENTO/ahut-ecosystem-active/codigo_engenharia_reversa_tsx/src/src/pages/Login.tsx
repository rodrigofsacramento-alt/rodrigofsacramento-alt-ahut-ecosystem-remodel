        ...
        <div className="w-full max-w-md space-y-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="relative flex items-center justify-center w-10 h-10">
              <div className="absolute inset-0 bg-[#00FFCC] rounded-full blur-xl opacity-40"></div>
              <svg className="relative z-10 w-9 h-9 text-[#00FFCC] drop-shadow-[0_0_8px_rgba(0,255,204,0.8)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm0-14a4 4 0 100 8 4 4 0 000-8zM12 12l3.5 3.5"></path>
              </svg>
            </div>
            <div>
              <h1 className="text-xl font-black tracking-tighter text-white">
                QUB<span className="text-[#00FFCC]">ITS</span>
              </h1>
              <p className="text-[10px] text-slate-500 tracking-widest uppercase">Ecossistema Inteligente</p>
            </div>
          </div>
          <div>
          ...
          <p className="text-center text-xs text-slate-500">
            © {new Date().getFullYear()} QUBITS. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </div>
